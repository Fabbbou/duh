...
func InitializeContexts(basePath *string) (service.CliService, error) {
	// var pathProvider file_service.PathProvider
	// if basePath != nil {
	// 	pathProvider = file_service.NewCustomPathProvider(*basePath)
	// } else {
	// 	pathProvider = &file_service.BasePathProvider{}
	// }
...
// 	userPrefRepo, err := file_db.NewTomlDbRepository(userPreferencePath)
// 	if err != nil {
// 		return service.CliService{}, err
// 	}
...
// 	dbRepoFactory := file_db.NewTomlDbRepositoryFactory()
